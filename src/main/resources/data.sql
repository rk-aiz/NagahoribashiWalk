...
INSERT INTO spots (pv_count, spot_name, sub_category_id, address, business_hours, closed_days, estimated_budget, details, website_url, gmap_url, keywords) VALUES (100, 'なんばグランド花月', (SELECT id FROM sub_categories WHERE name = '劇場'), '542-0075大阪府大阪市中央区難波千日前11-6', '一般的 10:00～22:00', '不定休(HP詳細)', '3000円～', '新喜劇と漫才が楽しめる笑いの殿堂', 'https://ngk.yoshimoto.co.jp/', 'https://maps.app.goo.gl/Dcc4azPiUHdewJXf7', 'お笑い,吉本,新喜劇,劇場,観光,定番');
